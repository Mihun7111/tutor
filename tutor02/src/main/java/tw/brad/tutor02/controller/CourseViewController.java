package tw.brad.tutor02.controller;
...
import tw.brad.tutor02.dto.CourseSearchDTO;
import tw.brad.tutor02.entity.Course;
import tw.brad.tutor02.entity.TutorSchedule;
import tw.brad.tutor02.repo.CourseRepo;
import tw.brad.tutor02.repo.TutorScheduleRepo;
import tw.brad.tutor02.spec.CourseSpec;
...
public class CourseViewController {
    ...
    public Map<Integer, List<Integer>> getTeacherSchedule(@PathVariable Long teacherId) {
        ...
        List<TutorSchedule> schedules = scheduleRepo.findByUserId(teacherId);
